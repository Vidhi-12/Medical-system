    ...
    <div class="col-sm-9" style=" background-color: #06ccd9; padding-top:10px;">
       ...
       <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\46.jpg">
          <p><strong>Soulflower Breathe Easy Essential Oil</strong></p>
          <p>MRP 428</p>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\47.jpg">
          <p><strong>Neeri Syrup</strong></p>
          <p>MRP 140</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
         <img src="image\featured\48.jpg">
          <p><strong>IMC Shri Tulsi Drop</strong></p>
          <p>MRP 181</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	     ...
	     <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\49.jpg">
          <p><strong>SBL Drops No. 6 (For Joint Pain)</strong></p>
          <p>MRP 120</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\50.jpg">
          <p><strong>St.Botanica Fish Oil 1000mg (Omega 3)<!--- 600mg Capsule---></strong></p>
          <p> MRP 799</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
         <img src="image\featured\51.jpg">
          <p><strong>Volini Spray</strong></p>
          <p>MRP 221</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\52.jpg">
          <p><strong>Omron MD300C20-Nmr Pulse Oximeter</strong></p>
          <p>MRP 1855</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\53.jpg">
          <p><strong>SBL Tonsilat Tablet</strong></p>
          <p>MRP 120</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
