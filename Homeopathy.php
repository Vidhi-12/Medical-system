      ...
      <div class="col-sm-3"  style=" background-color: #06ccd9;" >
			<div class="left">
				<ul id="myMenu">
					...
					<li><a href="Healthcare Devices.php">Healthcare Devices</a></li>
    ...
    <div class="col-sm-9" style=" background-color: #06ccd9; padding-top:10px;">
       ...
       <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\64.jpg">
          <p><strong>Omron MC-720 Non-Contact Forehead Thermometer</strong></p>
          <p>MRP 1853</p>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\65.jpg">
          <p><strong>Adven Osteodin-Z Oral Drops <br>30 ml</strong></p>
          <p>MRP 400</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
         <img src="image\featured\66.jpg">
          <p><strong>Hahnemann Glow More For Acne & Scar Drop Pack of 2</strong></p>
          <p>MRP 221</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	     ...
	     <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\67.jpg">
          <p><strong>SBL Denton Tablet</strong></p>
          <p>MRP 123</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\68.jpg">
          <p><strong><!---Dr Willmar Schwabe Germany Cineraria---> Maritima Without Alcohol Eye Drop</strong></p>
          <p>MRP 131</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
         <img src="image\featured\69.jpg">
          <p><strong>Bjain Omeo Piles Tablet</strong></p>
          <p>MRP 97</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	     ...
	     <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\70.jpg">
          <p><strong>Bakson's Vitamin D Plus Capsule</strong></p>
          <p>MRP 218</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
          <img src="image\featured\71.jpg">
          <p><strong>SBL Sleeptite Tablet</strong></p>
          <p>MRP 120</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
	   ...
	   <div class="col-sm-4">
        <div class="thumbnail text-center">
         <img src="image\featured\72.jpg">
          <p><strong>Bakson's Throat Aid Tablet</strong></p>
          <p>MRP 136</p>
          <button class="btn">Buy Tickets</button>
        </div>
      </div>
